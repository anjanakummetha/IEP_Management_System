        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50/50">
              ...
              <th className="text-left text-xs uppercase tracking-wide text-slate-500 font-medium px-6 py-4">Disability</th>
              <th className="text-left text-xs uppercase tracking-wide text-slate-500 font-medium px-6 py-4">Risk Level</th>
              <th className="text-left text-xs uppercase tracking-wide text-slate-500 font-medium px-6 py-4">Review Date</th>
            </tr>
          </thead>
